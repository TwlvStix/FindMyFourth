...
void main() {
  ...
  test('rule 1 applies for drinking mismatch with strong pace+chat', () {
    ...
    expect(result.bonusTotal, closeTo(0.02, 0.0001));
  ...
  test('rule 3 applies for chat mismatch with casual competitive score', () {
    final scores = {
      ...baseScores(),
  ...
  test('rule 4 applies for competitive mismatch with pace+money alignment', () {
    final scores = {
      ...baseScores(),
      VibeCategory.competitive: 0.2,
      VibeCategory.money: 0.85,
      VibeCategory.pace: 0.85,
    };
    final result = interactionAdjustments(
      scores,
  ...
  test('bonus total is capped at 0.04', () {
    final scores = {
      VibeCategory.pace: 0.9,
      VibeCategory.chat: 0.2,
      VibeCategory.competitive: 0.9,
    ...
    expect(result.appliedRules.length, 2);
  });
