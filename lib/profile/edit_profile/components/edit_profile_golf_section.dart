...
/// Golf profile section of the Edit Profile screen.
///
/// Displays home course dropdown, handicap counter, and Golf Canada number.
/// Receives course data from parent (parent owns the StreamBuilder).
class EditProfileGolfSection extends StatelessWidget {
  const EditProfileGolfSection({
    super.key,
    ...
    this.coursesValueController,
    this.golfCanadaValidator,
  });
  ...
  /// Callback when handicap value changes
  final ValueChanged<int> onHandicapChanged;

  /// Controller for Golf Canada number field
  final TextEditingController golfCanadaController;

  /// Controller for courses dropdown (optional, created if not provided)
  final FormFieldController<String>? coursesValueController;

  /// Validator for Golf Canada number
  final String? Function(String?)? golfCanadaValidator;
      ...
      child: Column(
        ...
        children: [
          ...
          AppTextField(
            ...
            prefixPhosphorIcon: AppPhosphorIcons.verified,
            keyboardType: TextInputType.number,
            inputFormatters: [FilteringTextInputFormatter.digitsOnly],
            validator: golfCanadaValidator,
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          AppCountController(
            decrementIconBuilder: (enabled) => _buildCounterButton(enabled),
            incrementIconBuilder: (enabled) => _buildCounterButton(enabled, isIncrement: true),
  ...
  Widget _buildCounterButton(bool enabled, {bool isIncrement = false}) {
    return Container(
      width: 32,
      height: 32,
      decoration: BoxDecoration(
      ...
      child: Icon(
        isIncrement ? AppPhosphorIcons.plus : AppPhosphorIcons.minus,
