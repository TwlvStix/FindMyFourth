...
class _NotificationSettingsWidgetState
  ...
  Widget _buildMutedThreadsCard(NotificationPreferences prefs) {
    final mutedCount = prefs.mutedThreads.length;
    final subtitle = mutedCount == 1 ? '1 muted' : '$mutedCount muted';

    return GestureDetector(
      onTap: () {
        // TODO: Navigate to muted threads management screen
        ScaffoldMessenger.of(context).hideCurrentSnackBar();
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
